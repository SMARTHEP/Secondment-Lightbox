...
history_ = deep_model.fit(train_input, y1, epochs=1000, verbose=1)
model_folder = '/Users/leonbozianu/work/lightbox/models/{}'.format("model_bayes_other")
if not os.path.exists(model_folder):
    os.makedirs(model_folder)
deep_model.save_weights(filepath=model_folder+'/final_weight.h5')
print("Saved model. Now plotting...")
