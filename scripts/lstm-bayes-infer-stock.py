...
dmodel = tf.keras.Sequential([
  tf.keras.layers.LSTM(32,activation='relu',input_shape=(sequence_length,1)),
...
# Restore the weights
model_save_loc = "/Users/leonbozianu/work/lightbox/models/model_bayes_other" + "/final_weight.h5"
